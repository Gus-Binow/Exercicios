#Crie um programa que gere uma senha aleatória de 12 caracteres, contendo pelo menos:
#uma letra maiúscula uma minúscula, um número e um caractere especial. Exiba a senha gerada.
import os
import random
os.system('cls')
